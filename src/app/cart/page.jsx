    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <h1 className="text-2xl font-semibold text-center mb-8 text-black">CART <span className="font-normal">({items.length} items)</span></h1>
        ...
        <div className="border border-gray-200 p-5 h-fit">
          ...
          <div className="flex gap-2 items-center">
            ...
            <button className="px-4 py-2 border border-gray-900 text-gray-900 text-sm">Check</button>
          </div>
